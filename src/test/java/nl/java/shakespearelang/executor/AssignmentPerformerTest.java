...
public class AssignmentPerformerTest {
    ...
    public void when_a_character_is_named_the_value_of_that_character_is_used() {
        Assignment assignment = new Assignment(new CharacterAsString("hamlet"), "you are as small as Juliet");
    ...
    public void when_an_subject_is_named_the_value_of_that_object_is_used() {
        Assignment assignment = new Assignment(new CharacterAsString("hamlet"), "you are as small as thyself");
    ...
    public void remainder_of_quotient_and_key_me_equal_to_zero() {
        Assignment assignment = new Assignment(new CharacterAsString("hamlet"), "the remainder of the quotient between juliet and me");
    ...
    public void square_root() {
        Assignment assignment = new Assignment(new CharacterAsString("hamlet"), "you are as villainous as the square root of romeo");
    ...
    @Test
    public void nothing(){
        Assignment assignment = new Assignment(new CharacterAsString("hamlet"), "thou art as rotten as the difference between nothing and the sum of a snotty stinking half-witted hog and a small toad");
    ...
    public void youAreNothing(){
    	Assignment assignment = new Assignment(new CharacterAsString("hamlet"), "you are nothing");
